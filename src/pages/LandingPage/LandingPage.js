  ...
  const smallArticles = [
    {
      ...
      summary: 'Discover how modern hotels are creating truly memorable experiences by focusing on personalized services, unique amenities, and immersive local culture.',
      image: img1,
    },
    {
      title: 'Luxury Reimagined',
      summary: 'Iconic hotels around the world are undergoing stunning renovations to blend heritage with contemporary luxury. ',
      image: img2,
    },
    {
      title: 'Preserving History',
      summary: 'Heritage hotels are not just places to stay—they are living museums. Learn how these hotels preserve architectural beauty, historical artifacts, and cultural traditions while offering modern comforts to their guests.',
      image: img3,
    },
  ];
...
{/* =============================== highlight-section======================================= */}
  ...
  {archImages.map((img, idx) => (
    <div
      key={idx}
      className={`highlight-img-card ${idx === Math.floor(archImages.length / 2) ? 'center-card' : ''}`}
    >
              ...
              <Card.Body className="d-flex flex-column">
                <div className="article-meta text-muted small mb-2 d-flex justify-content-between">
                  <span className="d-flex align-items-center">
                    <AccessTimeIcon fontSize="small" className="me-1" /> 4 min read
                  </span>

                  <span className="d-flex align-items-center">
                    <CalendarMonthIcon fontSize="small" className="me-1" /> 25 Nov 2025
                  </span>
                </div>
                ...
                <Card.Text className="main-summary">
                  Explore the growing trend of boutique hotels offering unique experiences...
                </Card.Text>

                <a href="#" className="read-more-link mt-auto d-flex justify-content-end">
